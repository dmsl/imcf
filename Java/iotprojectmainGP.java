/*
    This file implements the IMCF local controller main for using the
    Green Planner algorithm.
...
public class iotprojectmainGP {

	private double formaliseMaxError = 0.0;

	public iotprojectmainGP() {
	}
	...
	public static void main(String[] args) {
		...
		/**/
		 ...
		 String pathMRT="C:\\Users\\anton\\Documents\\EPL400\\Data\\MRTrules.txt";
		 String
		 pathDATA="C:\\Users\\anton\\Documents\\EPL400\\GreenPlanner\\green_data.txt";
		 String pathNoIFTTresults=
		 "C:\\Users\\anton\\Documents\\EPL400\\Data\\noiftt_results.txt";
		 

		// Paths for server
		/*
		String pathIFTT = "apartmentData/IFTTrules.txt";
		String pathMRT = "apartmentData/MRTapartment.txt";
		String pathDATA = "apartmentData/green_data.txt";
		String pathNoIFTTresults = "noiftt_results.txt";
		*/
		iotprojectmainGP project = new iotprojectmainGP();
		importData impdata = new importData(pathMRT, pathIFTT, pathDATA);

		// get updated meta-rules for Green Planner project
		impdata.get_updated_MRTrules_GP();
		 ...
		 * 
		 * 
		 * // run with meta rules mrt mr = new mrt();
		 * mr.MR(impdata.getIotData(),impdata.getMRTrules(),project.formaliseMaxError);
		 * 
		 * // run with ifttt rules ifttt iftt = new ifttt();
