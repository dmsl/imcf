      ...
      <div class="row justify-content-center">
          <div class="col-md-8">
            ...
            <br><br>
              ...
              <div class="card">
                  <div class="card-header">OpenHAB Configurations - Local Controller</div>

                  <div class="card-body">
                      <div class="panel-body">
                        <div>
                          <div class="float-md-left"><h1>OpenHAB Rules Table</h1> </div>
                          <div class="float-md-right"><a href="/retrieve-openhab-local" class="btn btn-primary">Retrieve OpenHAB Rules</a></div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Laravel/imcf/resources/views/openhab/openhablocal.blade.php ENDPATH**/ ?>